export class GameConfig {
    constructor() {
        ...
        // GameRules.SetPreGameTime(10); // 进入游戏后号角吹响前的准备时间
        ...
        game.SetCameraDistanceOverride(1700);
        ...
        // }
        game.SetCustomAttributeDerivedStatValue(AttributeDerivedStats.AGILITY_ATTACK_SPEED, 0.01);
    }
}
